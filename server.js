...
const dataBase = "mongodb+srv://martyrs:martyrs@cluster0.h3lxjgm.mongodb.net/?retryWrites=true&w=majority"
...
app.get('/help', async (req, res) => {
    ...
    const rec = await HelpModel.find({verified:true}).limit(8).skip(8 * (currPage - 1))
    res.json(rec)
})
